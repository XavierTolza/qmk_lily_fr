...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *                   |LCtrl | LGUI | LAlt | / Enter /       \Space \  | Git  | Debug|      |
     *                   |      |      |      |/   L1  /         \  L1  \ |(RALT)|(RCTL)|      |
     *                   `----------------------------'           '------''--------------------'
     */
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, LT(_OS, KC_LGUI), KC_LALT, LT(_SPECIAL, KC_ENT), LT(_SPECIAL, KC_SPACE), KC_RALT, KC_RCTL, KC_NONE),
