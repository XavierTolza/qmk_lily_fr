...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *                   |LCtrl | LGUI | LAlt | / Enter /       \Space \  |  git |debug | LCtrl|
     *                   |      |      |      |/       /         \  L1  \ |      |      |      |
     *                   `----------------------------'           '------''--------------------'
     */
    [_BASE] = LAYOUT(
        ...
        LCTL_T(OSM(MOD_MEH)), FR_W, FR_X, FR_C, FR_V, FR_B, _______,                LALT(KC_F4), FR_N, FR_COMM, FR_SCLN, FR_COLN, KC_SLSH,KC_LCTL,
                KC_LCTL, KC_LGUI, KC_LALT, LT(_SPECIAL, KC_ENT),                    LT(_SPECIAL, KC_SPACE), LT(_GIT, VSC_SWG), KC_RGUI, KC_LCTL
        ),
     ...
     */
    [_SPECIAL] = LAYOUT(
        VSC_SWF, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                                     KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, TG(2),
        VSC_SWS, FR_TILD, FR_SLSH, FR_LCBR, FR_RCBR, FR_PERC,                           FR_EQL, _______, KC_UP, FR_QUOT, FR_DQUO, FR_GRV,
        VSC_SWG, FR_EURO, FR_BSLS, FR_LPRN, FR_RPRN, FR_AT,                              KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,
        VSC_SWD, VSC_SWD, FR_DLR, FR_PIPE, FR_LBRC, FR_RBRC, FR_HASH, KC_PGDN,         KC_PGUP, FR_MINS, FR_PLUS, FR_EQL, FR_ASTR, FR_EXLM, _______,
    ...
    */
     ...
     * | Clone|      |      |      |      |      |                    |      |      |      |      | Pull |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |Submod|      |      |      |Releas|      |                    |      |      | Issue| Open | Push |      |
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * |      |      | stash|      | Fetch| Graph|-------.    ,-------|      |      |      |      | Merge|      |
     * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
     * |      |      |      |Commit|Valida|Branch|-------|    |-------|      |      |      |      |      |      |
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *                   |      |      |Checko| / Add   /       \      \  |      |      |      |
     *                   |      |      |  ut  |/       /         \      \ |      |      |      |
     *                   `----------------------------'           '------''--------------------'
...
/*
empty layout template to create a new layout
LAYOUT(
        _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, _______,
